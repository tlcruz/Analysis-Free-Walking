fc = 2093;
pathCtr = ['C:\Users\User\Dropbox (Sensorimotor)\ChiappeLabNew\DATA\TOMÁS\Free Walking VR\Data\Bilateral Stimulus Size\EmptySplit 10xKir\Fly ' num2str(fc) '\DataLowRes.mat'];
dtCtr = load(pathCtr);
dtCtr = dtCtr.Flies;
partsCtr = find(strcmp([dtCtr.Seq], '10NG'))';

fk = 2127;
pathKir = ['C:\Users\User\Dropbox (Sensorimotor)\ChiappeLabNew\DATA\TOMÁS\Free Walking VR\Data\Bilateral Stimulus Size\SplitT4T5 Kir\Fly ' num2str(fk) '\DataLowRes.mat'];
dtKir = load(pathKir);
dtKir = dtKir.Flies;
