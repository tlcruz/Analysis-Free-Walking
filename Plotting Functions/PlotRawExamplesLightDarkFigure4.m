...
pathDark = 'C:\Users\tomas\Dropbox (Sensorimotor)\ChiappeLabNew\data\TOMÁS\Free Walking VR\Data\Dark\Dark WTTB\Fly 1643\DataLowRes.mat';
dtDark = load(pathDark);
dtDark = dtDark.Flies;
partsDark = [3 4];

% Load the data in 10Deg conditions
pathLight = 'C:\Users\tomas\Dropbox (Sensorimotor)\ChiappeLabNew\data\TOMÁS\Free Walking VR\Data\Bilateral Stimulus Size\WT TB\Fly 1902\DataLowRes.mat';
